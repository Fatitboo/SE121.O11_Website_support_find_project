                                ...
                                <form action="#" method="post" className="w-full max" >
                                    <div className="w-full flex flex-col">
                                        ...
                                        <div className="flex justify-end mr-10">
                                            <CustomButton title="Update Occupation" containerStyles="text-blue-600 py-1.5 mt-8 px-3 focus:outline-none hover:bg-blue-700 hover:text-white rounded-md text-base border border-blue-600" />
                                        </div>

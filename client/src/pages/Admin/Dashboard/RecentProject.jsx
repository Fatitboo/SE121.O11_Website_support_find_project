        ...
        <tr  className="relative border-b border-solid border-[#ecedf2] w-full hover:bg-[#f4f2f2] cursor-pointer">
            <td className="relative pl-5 py-5 font-normal text-base">
                <div className="mb-0 relative h-14 ">
                    ...
                    <div className="pl-16  ">
                        <h4 className="font-medium text-md mb-1 line-clamp-1 w-44">{item.originazerName}</h4>
                        <div className="flex font-light text-sm mb-0"> <BiMap className="mt-1 mr-1" />  {item.address}</div>
                    </div>
                </div>
            </td>
            <td>
                <h4 className="font-medium text-ellipsis w-52 line-clamp-2">{item.projectName}</h4>
            </td>
            <td >
                <h4 className="text-center">{item.status}</h4>
            </td>
            <td className="font-light underline text-blue-400 text-center">

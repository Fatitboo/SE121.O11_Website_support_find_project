...
const vacancyList = [
    {
        logoVacancy:'https://superio-appdir.vercel.app/_next/image?url=%2Fimages%2Fresource%2Fcompany-logo%2F1-1.png&w=128&q=75',
        vacancyName:'Software Engineer (Android), Libraries',
        address:'London, UK',
        projectName:'Product of Dev Studio',
        numOfApplicants:'5',
        creExpDate:'16/03/2020-16/03/2023',
        status:'Active',
    },
    {
        logoVacancy:'https://superio-appdir.vercel.app/_next/image?url=%2Fimages%2Fresource%2Fcompany-logo%2F1-1.png&w=128&q=75',
                    ...
                    <div className="relative rounded-lg mb-8 bg-white shadow max-w-full px-3 pt-1 shrink-0 w-full">
                        <div className="relative w-full">
                            ...
                            <div className="relative flex justify-between items-center flex-wrap bg-transparent px-8 py-5">
                                ...
                                <div className="flex ">
                                    <h4 className="mr-1">My vacancies list: </h4> <span>  10</span>
                                </div>
                            </div>
                                ...
                                <div className="overflow-y-hidden overflow-x-auto">
                                    <table className="relative w-full overflow-y-hidden overflow-x-hidden rounded-md mb-8 bg-white border-0 ">
                                        <thead className="bg-[#f5f7fc] color-white border-transparent border-0 w-full">
                                            <tr className="w-full">
                                                <th className="relative text-[#3a60bf] font-medium py-6 text-base text-left w-3/12 pl-5 ">Title</th>
                                                <th className="relative text-[#3a60bf] font-medium py-6 text-base text-left w-3/12 ">Project Name</th>
                                                <th className="relative text-[#3a60bf] font-medium py-6 text-base text-left w-1/12 ">Applicants</th>
                                                <th className="relative text-[#3a60bf] font-medium py-6 text-base text-left w-2/12 pl-7">Created & Expired</th>
                                                        ...
                                                        <tr key={index} className="relative border-b border-solid border-[#ecedf2] w-full hover:bg-[#f4f2f2] cursor-pointer px-5  ">
                                                            <td className="relative pl-5 py-5 font-normal text-base w-3/12">
                                                                <div className="mb-0 relative h-16 ">
                                                                    ...
                                                                    <div className="pl-16">
                                                                        <h4 className="font-medium text-md text-ellipsis mb-1 line-clamp-2 ">{item.vacancyName}</h4>

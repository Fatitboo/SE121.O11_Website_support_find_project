    ...
    return (<>
        <div className="w-full h-[70vh] flex pt-24 items-center flex-col relative mb-10">
            ...
            <div className="w-[418px] flex items-center flex-col">
                <img src={CancelPaymentIcon} alt="" width={'80%'} />
                <div className="text-4xl font-bold mt-3 mb-2">Payment Failure!</div>
...
export default CancelPaymentProject;
...
import { CancelPaymentIcon } from "../../../assets/images";


function CancelPayment() {
    return (<>
        <div className="w-full h-[70vh] flex pt-24 items-center flex-col relative">
            <img src={CancelPaymentIcon} alt="img" className="absolute top-[20%] right-[20%] transition-all duration-[4000] ease-linear delay-[3000] animate-pulse " />
            ...
            <div className="w-[418px] flex items-center flex-col">
                ...
                <div className="text-sm text-blue-700">Payment Failure!</div>

            ...
            <Link to={`/Seeker/vacancy-info/${item?.vacancyId}`}>
                <div style={{ backgroundColor: active ? "#f6faff" : '' }} className="flex flex-row p-7 rounded-[10px] border border-[#ecedf2] hover:bg-[#f6faff] hover:shadow-[0_7px_18px_rgba(64,79,104,.05)] mb-[30px] cursor-pointer">
                    ...
                    <div className="ml-1">
                        ...
                        <div className="flex flex-row items-center mt-2">
                            {
                                item?.userInfo?.fullName ? (
                                    <div className="mr-3 bg-[rgba(25,103,210,.15)] text-[#1967d2] rounded-3xl flex">
                                        <span className="text-[13px] px-[20px] py-[5px] leading-none">{item?.userInfo?.fullName}</span>
                                    </div>
                                ) : null
                            }
                        ...
                        <div className="mt-2">
                            <p className="limitline3 bg-transparent h-16" dangerouslySetInnerHTML={{ __html: item?.description }}>
                            </p>
                        </div>
                        <div className="flex flex-row items-center mt-2">

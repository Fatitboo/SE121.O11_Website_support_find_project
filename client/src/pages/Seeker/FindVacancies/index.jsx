            ...
            <div className="flex flex-row gap-4 mx-[8%] pt-12">
                ...
                <div className="w-1/2 flex flex-col mb-[30px]">
                    <div className="flex sticky top-0 py-4 h-[100vh]">
                        <VacancyDetail vacancyName={vacancies[0].vacancyName} skillsRequired={vacancies[0].skillsRequired} maxRequired={vacancies[0].maxRequired} salary={vacancies[0].salary} registant={vacancies[0].registant} description={vacancies[0].description} isAvatar={false} companyName={vacancies[0].companyName} location={vacancies[0].location}/>
                    </div>
                </div>
            </div>
        </div>

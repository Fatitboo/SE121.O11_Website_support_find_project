...
const VacancyItem = ({vacancyName, skillsRequired, maxRequired, salary, registant, description, isAvatar, companyName, companyAvatar}) => {
    return (
        <>
            <div>
                        ...
                        isAvatar ? (
                            <div>
                                <div className="w-[50px] h-[50px] rounded-lg mr-2">
                                    <img src={companyAvatar} className="w-full h-full rounded-lg" alt="Logo"/>
                                </div>
                            </div>
                        ) : null
                    }

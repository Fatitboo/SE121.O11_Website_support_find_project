                ...
                <form className="mt-2 w-full" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex justify-between items-center mb-5">
                        <div className="flex items-center ">
                            <input type="checkbox" name="rememberMe" id="rememberMe" className="h-5 w-5 mr-1 "/>
                    ...
                    <CustomButton title={'Login'} type={'submit'} containerStyles={'bg-[#3c65f5] focus:bg-[#05264e] w-full py-4 pl-5 pr-5 rounded flex justify-center items-center text-white mb-3'}/>
                </form>
